...
- Пример с именем контейнера: `873:my-service:873`

Примечание: в поле DEST можно указывать имя Docker-контейнера (или hostname), если sidecar и целевой сервис подключены к одной Docker-сети.
