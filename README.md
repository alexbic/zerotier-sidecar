...
```bash
# Stable version (v1.x - Backend mode only)
docker pull alexbic/zerotier-sidecar:latest

# Gateway mode version (v2.x - All modes)
...
**Basic Format**: `EXTERNAL_PORT:DEST_IP:DEST_PORT`

**Backend Mode Examples**:
- Single service: `873:172.26.0.3:873`
- Multiple services: `873:172.26.0.3:873,22:172.26.0.4:22,80:172.26.0.5:8080`

**Gateway Mode Examples**:
- Forward to ZeroTier: `8989:10.121.15.16:8989`
- Multiple gateways: `8989:10.121.15.16:8989,443:10.121.15.20:443`
